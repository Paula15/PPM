...
const Vec3 Plane::DEFAULT_TEXV = Vec3(0, 0, 300);

// 调用此函数前需保证N和dir已经单位化
Intersection Plane::intersect(const Vec3 &ori, const Vec3 &dir, double &maxDist,/*output*/ Vec3 *P, Vec3 *N_, Color *objectColor) const
{
